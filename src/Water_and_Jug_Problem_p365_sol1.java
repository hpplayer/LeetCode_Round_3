 ...
 * Pure Math solution
 * 
 * The basic idea is to use the property of B¨¦zout's identity and check if z is
 * a multiple of GCD(x, y)
 * 
 * Quote from wiki:
 * 
 * B¨¦zout's identity (also called B¨¦zout's lemma) is a theorem in the elementary
 * theory of numbers:
 * 
 ...
 * divisor d. If a or b is negative this means we are emptying a jug of x or y
 ...
 * and emptying the 4 gallon jug once. (Solution. Fill the 6 gallon jug and
 * empty 4 gallons to the 4 gallon jug. Empty the 4 gallon jug. Now empty the
 * remaining two gallons from the 6 gallon jug to the 4 gallon jug. Next refill
 * the 6 gallon jug. This gives 8 gallons in the end)
 * 
 * 
...
public class Water_and_Jug_Problem_p365_sol1 {
	public boolean canMeasureWater(int x, int y, int z) {
	    ...
	    //if z is multiple of GCD(x,y), then it should also be true
	    return z%GCD(x, y) == 0;
	}
